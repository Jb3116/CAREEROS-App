    ...
    questions: [
      {
        ...
        rubric: {
          situation: 'Initial incident context',
          task: 'Diagnostic responsibility',
          action: 'Engineering mitigation',
          result: 'Quantified metrics (% reduction)',
          s: 'Initial incident context',
          t: 'Diagnostic responsibility',
          a: 'Engineering mitigation',
          r: 'Quantified metrics (% reduction)',
        },
      },
      {
        id: 'star-2',
        ...
        rubric: {
          situation: 'Conflicting design choices',
          task: 'Need for technical alignment',
          action: 'Data-driven proofs & benchmark',
          result: 'Successful consensus reached',
          s: 'Conflicting design choices',
          t: 'Need for technical alignment',
          a: 'Data-driven proofs & benchmark',
          r: 'Successful consensus reached',
        },
      },
      {
        id: 'star-3',
        ...
        rubric: {
          situation: 'Ambiguous scope',
          task: 'Need for product clarity',
          action: 'Modular sprint decomposition',
          result: 'On-time MVP launch',
          s: 'Ambiguous scope',
          t: 'Need for product clarity',
          a: 'Modular sprint decomposition',
          r: 'On-time MVP launch',
        },
      },
      {
        id: 'star-4',
        ...
        rubric: {
          situation: 'Production regression event',
          task: 'Immediate incident triage',
          action: 'Rollback & blameless post-mortem',
          result: 'Automated CI/CD guardrail added',
          s: 'Production regression event',
          t: 'Immediate incident triage',
          a: 'Rollback & blameless post-mortem',
          r: 'Automated CI/CD guardrail added',
        },
      },
    ],
  },
...
export async function generateFinalInterviewReport({
  ...
  return {
    ...
    metrics: {
      ...
      technical_depth_score: Math.min(98, Math.max(60, avgScore + 3)),
      problem_solving_score: Math.min(98, Math.max(60, avgScore + 4)),
      star_fluency_score: avgScore,
      speaking_pace_wpm: avgWpm || 135,
      clarity_score: Math.min(98, Math.max(60, avgScore + 2)),
    },
    strengths_summary: [
